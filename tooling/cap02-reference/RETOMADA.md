...
Esta referência acrescenta POST /pedidos/{id}/cancelamento: aberto 200;
pago/cancelado 409; ausente 404. Sem corpo. Cancelar novamente NÃO é idempotente
neste contrato didático. Leitura e escrita separadas não protegem concorrência.
