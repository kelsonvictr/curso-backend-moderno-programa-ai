...
(() => {
  ...
  const hexSteps=[
    ...
    {title:'7. Adapter JPA + Postgres',icon:'🐘',kind:'Entidade de persistência',code:'pedido(7f2c…, c-1, ABERTO) + item(CAFE-500, 2, 18.90)',before:'Pedido e contrato sem tecnologia',action:'Mapear para JPA e executar a persistência',after:'UUID 7f2c… preservado; itens persistidos; total calculado',proof:'Teste de integração consulta a linha no banco',question:'Previsão: se o banco mudar, qual peça concentra a troca?',tech:'jpa',boundary:'BORDA DE SAÍDA',explanation:'O adapter grava pedido e itens, sem coluna total. Ao reler, o domínio calcula 37.80. 7f2c… abrevia um UUID ilustrativo; a API gera um UUID real.'}
  ];
